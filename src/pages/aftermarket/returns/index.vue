  ...
  <div class="page-container">
    <el-card class="search-content">
      <el-form ref="search" :model="form" label-width="100px" size="mini">
        <el-form-item label="退货/退款单号" prop="code.value">
    ...
    <el-table :data="tableData" size="mini">
			...
			<el-table-column label="退货/退款单号" prop="afterSaleOrderNo"></el-table-column>
			...
			<el-table-column label="售后状态" prop="auditStatus">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      showDetail(row) {
        this.$router.push({ path: '/aftermarket/returns/details', query: { id: row.id } })
      },
